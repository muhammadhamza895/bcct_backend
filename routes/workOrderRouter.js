...
import { checkPriority, checkDeliveryDate, checkWorkOrderStatus, checkPendingStatus, checkWorkOrderUsedInInventory, checkJobId } from '../middlewares/workOrderMiddleware.js';
...
workOrderRouter.post("/create-work-order", checkJobId, jobVerifier, checkPriority, checkTasks, createWorkOrder)
